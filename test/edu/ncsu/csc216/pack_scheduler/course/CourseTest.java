...
public class CourseTest {
	...
	/** enrollment cap */
	private static final int ENROLL_CAP = 25;
...
//		}
	...
	public void testSetMeetingDays() {
		...
		//Test that non day character throws error
		try {
			c.setMeetingDays("Z");
			fail();
		} catch (IllegalArgumentException e) {
	...
	/**
	 * tests whether two courses are equal, less than, or greater than one another when comparing their name
	 * and then their section.
	 */
	@Test
	public void testCompareTo() {
		...
		assertTrue(0 < c3.compareTo(c2));
		assertTrue(0 > c1.compareTo(c2));
	}
	/**
	 * tests the isDuplicate method of course. 
	 */
	@Test
