...
/**
 * The Mino class extends Niox and has a list of components.
 * 
...
public class Mino extends Product implements Consumable {
	 ...
	 * 
	 */
	public Mino() { // primary constructor
		super(desc, pn, p, GENERATION);
	 ...
	 *
	public MinoProduct(String desc, String pn, double p) {
...
//		}
	...
	public String toString() {
		return getGeneration() + "," + getPartNumber() + "," + getDescription() + "," + getPrice();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Mino other = (Mino) obj;
		if (GENERATION != other.getGeneration())
			return false;
	...
	public String[] getShortDisplayArray() {
		String[] shortMinoInfo = {getDescription(), getPartNumber(), getGeneration()}; 
		return shortMinoInfo;
	}
	...
	public String[] getLongDisplayArray() {
		String[] longMinoInfo = {getDescription(), getPartNumber(), getGeneration() };
		return longMinoInfo;
	}
	...
	public boolean isDuplicate(Product product){
		...
		if (product instanceof Mino){
			Mino temp = (Mino) product;
			if( temp.getPartNumber().equals(this.getPartNumber() ) && 
	 ...
	 */
	@Override
	public int compareTo(Mino c) {

		int compareResult;
		String thisProduct = new String(this.getDescription() + " " + this.getPartNumber());
		String compareProduct = new String(c.getDescription() +  " " + c.getPartNumber());	
		
		compareResult = thisProduct.compareTo(compareProduct);
