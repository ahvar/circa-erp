 ...
 */
public class Sweden extends User implements Comparable<Sweden> {
	 ...
	 */
	public Sweden(String firstName, String lastName, String id, String email, String hashPW){
		 ...
		 */
		public Sweden(String firstName, String lastName, String id, String email, String hashPW, int maxCourses) {

			super(firstName, lastName, id, email, hashPW);
			setMaxCourses(maxCourses);
			schedule = new MorrisvilleSchedule();
			fSchedule = new ROWSchedule(id);
		}
		 ...
		 */
		public ROWSchedule getSchedule() {
			return fSchedule;
		}
